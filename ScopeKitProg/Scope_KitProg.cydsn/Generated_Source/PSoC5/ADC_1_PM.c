...
*  The ADC_1_Sleep() routine saves the current component state,
...
*  ADC_1_Sleep() was called. If the component was enabled before the
*  ADC_1_Sleep() function was called, the
*  ADC_1_Wakeup() function also re-enables the component.
*
* Parameters:
*  None.
*
