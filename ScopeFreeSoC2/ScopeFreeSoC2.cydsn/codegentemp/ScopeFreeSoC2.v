// ======================================================================
// ScopeFreeSoC2.v generated from TopDesign.cysch
// 06/12/2022 at 14:02
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_vref_v1_60"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_vref_v1_60\cy_vref_v1_60.v"
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_vref_v1_60"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_vref_v1_60\cy_vref_v1_60.v"
`endif
...
// ADC_SAR_v3_0(ADC_Clock=0, ADC_Clock_Frequency=13500000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=1, ADC_Resolution=12, ADC_SampleMode=2, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=6, Sample_Rate=750000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONFIG_TITLE=ADC_2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_2, CY_INSTANCE_SHORT_NAME=ADC_2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=ADC_2, )
...
// ADC_SAR_v3_0(ADC_Clock=0, ADC_Clock_Frequency=13500000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=1, ADC_Resolution=12, ADC_SampleMode=2, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=6, Sample_Rate=750000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONFIG_TITLE=ADC_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_1, CY_INSTANCE_SHORT_NAME=ADC_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=ADC_1, )
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_sync_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_sync_v1_0\cy_sync_v1_0.v"
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_sync_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_sync_v1_0\cy_sync_v1_0.v"
`endif
...
// Comp_v2_0(Hysteresis=1, Pd_Override=0, Polarity=0, PSOC5A=false, Speed=1, Sync=1, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=Comp_v2_0, CY_CONFIG_TITLE=Trigger_Comp, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Trigger_Comp, CY_INSTANCE_SHORT_NAME=Trigger_Comp, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=Trigger_Comp, )
module Comp_v2_0_3 (
    Vplus,
    CmpOut,
    Vminus,
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=156, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=2496, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=Vtrigger, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Vtrigger, CY_INSTANCE_SHORT_NAME=Vtrigger, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=Vtrigger, )
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\xor_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\xor_v1_0\xor_v1_0.v"
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\xor_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\xor_v1_0\xor_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\EdgeDetect_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\EdgeDetect_v1_0\EdgeDetect_v1_0.v"
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\EdgeDetect_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\EdgeDetect_v1_0\EdgeDetect_v1_0.v"
`endif
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=1, VDAC_Range=0, VDAC_Speed=2, Voltage=400, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=VDAC8, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Wave_DAC:VDAC8, CY_INSTANCE_SHORT_NAME=VDAC8, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=Wave_DAC_VDAC8, )
...
// OpAmp_v1_90(Mode=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONFIG_TITLE=Wave_Buf, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Wave_Buf, CY_INSTANCE_SHORT_NAME=Wave_Buf, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=Wave_Buf, )
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\LUT_v1_50"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\LUT_v1_50\LUT_v1_50.v"
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\LUT_v1_50"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\LUT_v1_50\LUT_v1_50.v"
`endif

// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=true, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=3, CompareType2Software=0, CompareValue1=0, CompareValue2=0, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=false, Period=249, PWMMode=1, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=false, TermVisibility_pwm1=true, TermVisibility_pwm2=true, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=true, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=Digital_PWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Digital_PWM, CY_INSTANCE_SHORT_NAME=Digital_PWM, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=Digital_PWM, )
module PWM_v3_30_9 (
    reset,
    clock,
    tc,
...
// OpAmp_v1_90(Mode=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONFIG_TITLE=Trig_Buf, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Trig_Buf, CY_INSTANCE_SHORT_NAME=Trig_Buf, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=Trig_Buf, )
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.3\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\FreqDiv_v1_0"
...
module top ;
    ...
    USBFS_v3_10_2 USBUART (
        .sof(Net_1055),
        .vbusdet(1'b0));
    defparam USBUART.epDMAautoOptimization = 0;

	wire [0:0] tmpOE__Scope_A_net;
	wire [0:0] tmpFB_0__Scope_A_net;
	wire [0:0] tmpIO_0__Scope_A_net;
	wire [0:0] tmpINTERRUPT_0__Scope_A_net;
	electrical [0:0] tmpSIOVREF__Scope_A_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("05a9c8de-3ba2-4909-8250-95fdc61c0bf4"),
		  ...
		  .input_buffer_sel(2'b00))
		Scope_A
		 (.oe(tmpOE__Scope_A_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Scope_A_net[0:0]}),
		  .analog({Net_864}),
		  .io({tmpIO_0__Scope_A_net[0:0]}),
		  .siovref(tmpSIOVREF__Scope_A_net),
		  .interrupt({tmpINTERRUPT_0__Scope_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Scope_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Scope_B_net;
	wire [0:0] tmpFB_0__Scope_B_net;
	wire [0:0] tmpIO_0__Scope_B_net;
	wire [0:0] tmpINTERRUPT_0__Scope_B_net;
	electrical [0:0] tmpSIOVREF__Scope_B_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ffff141b-4b3c-4fbf-a287-f50d57a5ca42"),
		  ...
		  .input_buffer_sel(2'b00))
		Scope_B
		 (.oe(tmpOE__Scope_B_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Scope_B_net[0:0]}),
		  .analog({Net_105}),
		  .io({tmpIO_0__Scope_B_net[0:0]}),
		  .siovref(tmpSIOVREF__Scope_B_net),
		  .interrupt({tmpINTERRUPT_0__Scope_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Scope_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_139 = ~Net_137;


    assign Net_124 = Net_135 & Net_139;
    ...
    VDAC8_v1_90_4 Vtrigger (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_157));
    defparam Vtrigger.Data_Source = 0;
    defparam Vtrigger.Initial_Value = 156;
    defparam Vtrigger.Strobe_Mode = 0;

    // -- AMux Amux_Trigger start -- ***
    // -- Mux A --
    
    cy_psoc3_amux_v1_0 Amux_Trigger(
        .muxin({
            Net_105,
            Net_864
            }),
    ...
    defparam Amux_Trigger.muxin_width = 2;
    defparam Amux_Trigger.init_mux_sel = 2'h0;
    defparam Amux_Trigger.one_active = 1;
    defparam Amux_Trigger.connect_mode = 1;
    
    // -- AMux Amux_Trigger end --

    cy_sync_v1_0 Sync_3 (
        .s_in(Net_281),
        .clock(Net_491),
        .s_out(Net_249));
    defparam Sync_3.SignalWidth = 1;

    CyControlReg_v1_80 Trigger_Control (
        .control_1(Net_236),
        .control_2(TrigMux[0]),
        .control_3(TrigMux[1]),
        .control_0(Net_235),
        ...
        .clock(Net_1109),
        .reset(1'b0));
    defparam Trigger_Control.Bit0Mode = 1;
    defparam Trigger_Control.Bit1Mode = 1;
    defparam Trigger_Control.Bit2Mode = 1;
    defparam Trigger_Control.Bit3Mode = 1;
    defparam Trigger_Control.Bit4Mode = 1;
    defparam Trigger_Control.Bit5Mode = 1;
    defparam Trigger_Control.Bit6Mode = 1;
    defparam Trigger_Control.Bit7Mode = 1;
    defparam Trigger_Control.BitValue = 0;
    defparam Trigger_Control.BusDisplay = 0;
    defparam Trigger_Control.ExtrReset = 1;
    defparam Trigger_Control.NumOutputs = 8;
    ...
    assign Net_262 = Net_246 & Net_251;


    assign Net_251 = Net_249 ^ Net_236;


    assign Net_246 = Net_281 ^ Net_235;


    assign Net_261 = Net_246 ^ Net_251;

    // -- Mux start --
    if (1)
    begin : Trigger_EdgeMux
        reg  tmp__Trigger_EdgeMux_reg;
        always @(Net_262 or Net_261 or Net_550 or Net_535 or TrigMux)
        begin
            case (TrigMux[1:0])
                2'b00 :  tmp__Trigger_EdgeMux_reg = Net_262;
                2'b01 :  tmp__Trigger_EdgeMux_reg = Net_261;
                2'b10 :  tmp__Trigger_EdgeMux_reg = Net_550;
                2'b11 :  tmp__Trigger_EdgeMux_reg = Net_535;
            endcase
        end
        assign Trigger = tmp__Trigger_EdgeMux_reg;
    end
    // -- Mux end --
    ...
    cy_sync_v1_0 Sync_4 (
        ...
        .clock(Net_491),
        .s_out(Net_281));
    defparam Sync_4.SignalWidth = 1;

    PWM_v3_30_5 PWM_Sample_Buffer (
        .reset(Net_398),
        .clock(Net_491),
        .tc(Net_600),
        .pwm1(Net_1060),
        ...
        .ph1(Net_1067),
        .ph2(Net_1068));
    defparam PWM_Sample_Buffer.Resolution = 16;


    assign Net_131 = Net_491 & Net_601;


    assign Net_350 = Net_125 & Net_601;

    CyStatusReg_v1_90 Trigger_Status (
        .status_0(Net_605),
        .status_1(Net_510),
        .status_2(Net_509),
        .status_3(1'b0),
        ...
        .intr(Net_445),
        .status_bus(8'b0));
    defparam Trigger_Status.Bit0Mode = 0;
    defparam Trigger_Status.Bit1Mode = 1;
    defparam Trigger_Status.Bit2Mode = 1;
    defparam Trigger_Status.Bit3Mode = 0;
    defparam Trigger_Status.Bit4Mode = 0;
    defparam Trigger_Status.Bit5Mode = 0;
    defparam Trigger_Status.Bit6Mode = 0;
    defparam Trigger_Status.Bit7Mode = 0;
    defparam Trigger_Status.BusDisplay = 0;
    defparam Trigger_Status.Interrupt = 0;
    defparam Trigger_Status.MaskValue = 0;
    defparam Trigger_Status.NumInputs = 8;
    ...
    // -- SRFF Start --
    reg  cy_srff_1;
    always @(posedge Net_463)
    begin
        cy_srff_1 <= (ARM | Net_601) & ~Net_600;
    end
    assign Net_601 = cy_srff_1;
    // -- SRFF End --
    ...
    EdgeDetect_v1_0 EdgeDetect_Trigger (
        .d(Net_516),
        .det(Net_510),
        .clock(Net_498));
    defparam EdgeDetect_Trigger.EdgeType = 0;
    ...
    EdgeDetect_v1_0 EdgeDetect_CaptureComplete (
        .d(Net_600),
        .det(Net_509),
        .clock(Net_503));
    defparam EdgeDetect_CaptureComplete.EdgeType = 0;
    ...
    assign Net_551 = Net_265 | Net_533;

	wire [0:0] tmpOE__External_Trigger_net;
	wire [0:0] tmpIO_0__External_Trigger_net;
	wire [0:0] tmpINTERRUPT_0__External_Trigger_net;
	electrical [0:0] tmpSIOVREF__External_Trigger_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4c15b41e-e284-4978-99e7-5aaee19bd0ce"),
		  ...
		  .input_buffer_sel(2'b00))
		External_Trigger
		 (.oe(tmpOE__External_Trigger_net),
		  .y({1'b0}),
		  .fb({Net_533}),
		  .io({tmpIO_0__External_Trigger_net[0:0]}),
		  .siovref(tmpSIOVREF__External_Trigger_net),
		  .interrupt({tmpINTERRUPT_0__External_Trigger_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__External_Trigger_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    WaveDAC8_v2_10_7 Wave_DAC (
        .Wave(Net_577),
        .ws(Net_564),
        .clock(Net_1073),
        .wc1(Net_1074),
    ...
    // -- SRFF Start --
    reg  cy_srff_2;
    always @(posedge Net_543)
    begin
        cy_srff_2 <= (Net_551 | Net_550) & ~Net_600;
    end
    assign Net_550 = cy_srff_2;
    // -- SRFF End --
    ...
    OpAmp_v1_90_8 Wave_Buf (
        .Vplus(Net_577),
        .Vout(Net_573),
        .Vminus(Net_576));
    defparam Wave_Buf.Mode = 1;

	wire [0:0] tmpOE__Wave_Out_net;
	wire [0:0] tmpFB_0__Wave_Out_net;
	wire [0:0] tmpIO_0__Wave_Out_net;
	wire [0:0] tmpINTERRUPT_0__Wave_Out_net;
	electrical [0:0] tmpSIOVREF__Wave_Out_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("cc3bcd7e-5dc0-48ea-9bf6-6aa082be1ada"),
		  ...
		  .input_buffer_sel(2'b00))
		Wave_Out
		 (.oe(tmpOE__Wave_Out_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Wave_Out_net[0:0]}),
		  .analog({Net_573}),
		  .io({tmpIO_0__Wave_Out_net[0:0]}),
		  .siovref(tmpSIOVREF__Wave_Out_net),
		  .interrupt({tmpINTERRUPT_0__Wave_Out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Wave_Out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    CyControlReg_v1_80 Wave_Control (
        .control_1(Net_716),
        .control_2(Net_717),
        .control_3(Net_718),
        .control_0(Net_564),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Wave_Control.Bit0Mode = 0;
    defparam Wave_Control.Bit1Mode = 0;
    defparam Wave_Control.Bit2Mode = 0;
    defparam Wave_Control.Bit3Mode = 0;
    defparam Wave_Control.Bit4Mode = 0;
    defparam Wave_Control.Bit5Mode = 0;
    defparam Wave_Control.Bit6Mode = 0;
    defparam Wave_Control.Bit7Mode = 0;
    defparam Wave_Control.BitValue = 0;
    defparam Wave_Control.BusDisplay = 0;
    defparam Wave_Control.ExtrReset = 0;
    defparam Wave_Control.NumOutputs = 8;
    ...
    // -- LUT Trigger_LUT start --
    if (1)
    begin : Trigger_LUT
        reg [2:0] tmp__Trigger_LUT_reg;
        wire [4:0] tmp__Trigger_LUT_ins;
        assign tmp__Trigger_LUT_ins = {Net_641,Net_633,ARM,Trigger,Net_665};
        always @(posedge Net_648)
        begin
            case (tmp__Trigger_LUT_ins)
                5'b00000 :  tmp__Trigger_LUT_reg = 3'b001;
                5'b00001 :  tmp__Trigger_LUT_reg = 3'b001;
                5'b00010 :  tmp__Trigger_LUT_reg = 3'b001;
                5'b00011 :  tmp__Trigger_LUT_reg = 3'b001;
                5'b00100 :  tmp__Trigger_LUT_reg = 3'b011;
                5'b00101 :  tmp__Trigger_LUT_reg = 3'b011;
                5'b00110 :  tmp__Trigger_LUT_reg = 3'b011;
                5'b00111 :  tmp__Trigger_LUT_reg = 3'b011;
                5'b01000 :  tmp__Trigger_LUT_reg = 3'b011;
                5'b01001 :  tmp__Trigger_LUT_reg = 3'b101;
                5'b01010 :  tmp__Trigger_LUT_reg = 3'b011;
                5'b01011 :  tmp__Trigger_LUT_reg = 3'b101;
                5'b01100 :  tmp__Trigger_LUT_reg = 3'b011;
                5'b01101 :  tmp__Trigger_LUT_reg = 3'b101;
                5'b01110 :  tmp__Trigger_LUT_reg = 3'b011;
                5'b01111 :  tmp__Trigger_LUT_reg = 3'b101;
                5'b10000 :  tmp__Trigger_LUT_reg = 3'b101;
                5'b10001 :  tmp__Trigger_LUT_reg = 3'b110;
                5'b10010 :  tmp__Trigger_LUT_reg = 3'b101;
                5'b10011 :  tmp__Trigger_LUT_reg = 3'b110;
                5'b10100 :  tmp__Trigger_LUT_reg = 3'b101;
                5'b10101 :  tmp__Trigger_LUT_reg = 3'b110;
                5'b10110 :  tmp__Trigger_LUT_reg = 3'b101;
                5'b10111 :  tmp__Trigger_LUT_reg = 3'b110;
                5'b11000 :  tmp__Trigger_LUT_reg = 3'b110;
                5'b11001 :  tmp__Trigger_LUT_reg = 3'b110;
                5'b11010 :  tmp__Trigger_LUT_reg = 3'b001;
                5'b11011 :  tmp__Trigger_LUT_reg = 3'b001;
                5'b11100 :  tmp__Trigger_LUT_reg = 3'b110;
                5'b11101 :  tmp__Trigger_LUT_reg = 3'b110;
                5'b11110 :  tmp__Trigger_LUT_reg = 3'b001;
                5'b11111 :  tmp__Trigger_LUT_reg = 3'b001;
            endcase
        end
        assign {Net_641,Net_633,Net_685} = tmp__Trigger_LUT_reg;
    end
    // -- LUT Trigger_LUT end --
    ...
    assign Net_516 = Trigger_Block & Trigger;


    assign Net_699 = ~Net_685;

    // -- SRFF Start --
    reg  cy_srff_3;
    always @(posedge Net_701)
    begin
        cy_srff_3 <= (Net_699 | Trigger_Block) & ~CaptureComplete;
    end
    assign Trigger_Block = cy_srff_3;
    // -- SRFF End --
    ...
    CyControlReg_v1_80 Digital_Out_Control (
        .control_1(Net_747),
        .control_2(Net_748),
        .control_3(Net_749),
        .control_0(Net_750),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Digital_Out_Control.Bit0Mode = 0;
    defparam Digital_Out_Control.Bit1Mode = 0;
    defparam Digital_Out_Control.Bit2Mode = 0;
    defparam Digital_Out_Control.Bit3Mode = 0;
    defparam Digital_Out_Control.Bit4Mode = 0;
    defparam Digital_Out_Control.Bit5Mode = 0;
    defparam Digital_Out_Control.Bit6Mode = 0;
    defparam Digital_Out_Control.Bit7Mode = 0;
    defparam Digital_Out_Control.BitValue = 0;
    defparam Digital_Out_Control.BusDisplay = 0;
    defparam Digital_Out_Control.ExtrReset = 0;
    defparam Digital_Out_Control.NumOutputs = 8;
	...
	wire [0:0] tmpOE__DigOut_0_net;
	wire [0:0] tmpFB_0__DigOut_0_net;
	wire [0:0] tmpIO_0__DigOut_0_net;
	wire [0:0] tmpINTERRUPT_0__DigOut_0_net;
	electrical [0:0] tmpSIOVREF__DigOut_0_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("51160b23-329f-4ad3-96d6-0114e37aa0d2"),
		  ...
		  .input_buffer_sel(2'b00))
		DigOut_0
		 (.oe(tmpOE__DigOut_0_net),
		  .y({Net_750}),
		  .fb({tmpFB_0__DigOut_0_net[0:0]}),
		  .io({tmpIO_0__DigOut_0_net[0:0]}),
		  .siovref(tmpSIOVREF__DigOut_0_net),
		  .interrupt({tmpINTERRUPT_0__DigOut_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DigOut_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DigOut_1_net;
	wire [0:0] tmpFB_0__DigOut_1_net;
	wire [0:0] tmpIO_0__DigOut_1_net;
	wire [0:0] tmpINTERRUPT_0__DigOut_1_net;
	electrical [0:0] tmpSIOVREF__DigOut_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("5509ac58-d46a-4150-8b5d-3ab01f1a73c1"),
		  ...
		  .input_buffer_sel(2'b00))
		DigOut_1
		 (.oe(tmpOE__DigOut_1_net),
		  .y({Net_747}),
		  .fb({tmpFB_0__DigOut_1_net[0:0]}),
		  .io({tmpIO_0__DigOut_1_net[0:0]}),
		  .siovref(tmpSIOVREF__DigOut_1_net),
		  .interrupt({tmpINTERRUPT_0__DigOut_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DigOut_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DigIn_0_net;
	wire [0:0] tmpIO_0__DigIn_0_net;
	wire [0:0] tmpINTERRUPT_0__DigIn_0_net;
	electrical [0:0] tmpSIOVREF__DigIn_0_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("7f01244a-d67f-42e6-b1dc-3d54c542cb54"),
		  ...
		  .input_buffer_sel(2'b00))
		DigIn_0
		 (.oe(tmpOE__DigIn_0_net),
		  .y({1'b0}),
		  .fb({Net_757}),
		  .io({tmpIO_0__DigIn_0_net[0:0]}),
		  .siovref(tmpSIOVREF__DigIn_0_net),
		  .interrupt({tmpINTERRUPT_0__DigIn_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DigIn_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyStatusReg_v1_90 Digital_Input_Status (
        .status_0(Net_757),
        .status_1(Net_768),
        .status_2(Net_769),
        .status_3(Net_770),
        ...
        .intr(Net_776),
        .status_bus(8'b0));
    defparam Digital_Input_Status.Bit0Mode = 0;
    defparam Digital_Input_Status.Bit1Mode = 0;
    defparam Digital_Input_Status.Bit2Mode = 0;
    defparam Digital_Input_Status.Bit3Mode = 0;
    defparam Digital_Input_Status.Bit4Mode = 0;
    defparam Digital_Input_Status.Bit5Mode = 0;
    defparam Digital_Input_Status.Bit6Mode = 0;
    defparam Digital_Input_Status.Bit7Mode = 0;
    defparam Digital_Input_Status.BusDisplay = 0;
    defparam Digital_Input_Status.Interrupt = 0;
    defparam Digital_Input_Status.MaskValue = 0;
    defparam Digital_Input_Status.NumInputs = 8;

	wire [0:0] tmpOE__DigIn_1_net;
	wire [0:0] tmpIO_0__DigIn_1_net;
	wire [0:0] tmpINTERRUPT_0__DigIn_1_net;
	electrical [0:0] tmpSIOVREF__DigIn_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1786498c-2e52-445d-a327-0a8cde32c316"),
		  ...
		  .input_buffer_sel(2'b00))
		DigIn_1
		 (.oe(tmpOE__DigIn_1_net),
		  .y({1'b0}),
		  .fb({Net_768}),
		  .io({tmpIO_0__DigIn_1_net[0:0]}),
		  .siovref(tmpSIOVREF__DigIn_1_net),
		  .interrupt({tmpINTERRUPT_0__DigIn_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DigIn_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_9 Digital_PWM (
        ...
        .ph1(Net_1097),
        .ph2(Net_1098));
    defparam Digital_PWM.Resolution = 8;

	wire [0:0] tmpOE__PWMOut_0_net;
	wire [0:0] tmpFB_0__PWMOut_0_net;
	wire [0:0] tmpIO_0__PWMOut_0_net;
	wire [0:0] tmpINTERRUPT_0__PWMOut_0_net;
	electrical [0:0] tmpSIOVREF__PWMOut_0_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("6d5d67db-089e-4a86-b848-31708704ef42"),
		  ...
		  .input_buffer_sel(2'b00))
		PWMOut_0
		 (.oe(tmpOE__PWMOut_0_net),
		  .y({Net_797}),
		  .fb({tmpFB_0__PWMOut_0_net[0:0]}),
		  .io({tmpIO_0__PWMOut_0_net[0:0]}),
		  .siovref(tmpSIOVREF__PWMOut_0_net),
		  .interrupt({tmpINTERRUPT_0__PWMOut_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWMOut_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PWMOutB_0_net;
	wire [0:0] tmpFB_0__PWMOutB_0_net;
	wire [0:0] tmpIO_0__PWMOutB_0_net;
	wire [0:0] tmpINTERRUPT_0__PWMOutB_0_net;
	electrical [0:0] tmpSIOVREF__PWMOutB_0_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("d9c0dad5-a5e2-4c9d-8054-8bc00a81d1f5"),
		  ...
		  .input_buffer_sel(2'b00))
		PWMOutB_0
		 (.oe(tmpOE__PWMOutB_0_net),
		  .y({Net_798}),
		  .fb({tmpFB_0__PWMOutB_0_net[0:0]}),
		  .io({tmpIO_0__PWMOutB_0_net[0:0]}),
		  .siovref(tmpSIOVREF__PWMOutB_0_net),
		  .interrupt({tmpINTERRUPT_0__PWMOutB_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWMOutB_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Trig_Out_net;
	wire [0:0] tmpFB_0__Trig_Out_net;
	wire [0:0] tmpIO_0__Trig_Out_net;
	wire [0:0] tmpINTERRUPT_0__Trig_Out_net;
	electrical [0:0] tmpSIOVREF__Trig_Out_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("76498dc8-7a19-46cb-b367-ebf0aae1004b"),
		  ...
		  .input_buffer_sel(2'b00))
		Trig_Out
		 (.oe(tmpOE__Trig_Out_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Trig_Out_net[0:0]}),
		  .analog({Net_945}),
		  .io({tmpIO_0__Trig_Out_net[0:0]}),
		  .siovref(tmpSIOVREF__Trig_Out_net),
		  .interrupt({tmpINTERRUPT_0__Trig_Out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Trig_Out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    OpAmp_v1_90_10 Trig_Buf (
        .Vplus(Net_157),
        .Vout(Net_945),
        .Vminus(Net_949));
    defparam Trig_Buf.Mode = 1;

	wire [0:0] tmpOE__DigIn_4_net;
	wire [0:0] tmpIO_0__DigIn_4_net;
	wire [0:0] tmpINTERRUPT_0__DigIn_4_net;
	electrical [0:0] tmpSIOVREF__DigIn_4_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("be101bd1-3686-41d2-8eab-c1ed0608daca"),
		  ...
		  .input_buffer_sel(2'b00))
		DigIn_4
		 (.oe(tmpOE__DigIn_4_net),
		  .y({1'b0}),
		  .fb({Net_772}),
		  .io({tmpIO_0__DigIn_4_net[0:0]}),
		  .siovref(tmpSIOVREF__DigIn_4_net),
		  .interrupt({tmpINTERRUPT_0__DigIn_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DigIn_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    assign Net_774 = 1'h0;

	wire [0:0] tmpOE__DigIn_3_net;
	wire [0:0] tmpIO_0__DigIn_3_net;
	wire [0:0] tmpINTERRUPT_0__DigIn_3_net;
	electrical [0:0] tmpSIOVREF__DigIn_3_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ab544a71-b3a2-4a26-9433-2ea5fa16b5d6"),
		  ...
		  .input_buffer_sel(2'b00))
		DigIn_3
		 (.oe(tmpOE__DigIn_3_net),
		  .y({1'b0}),
		  .fb({Net_770}),
		  .io({tmpIO_0__DigIn_3_net[0:0]}),
		  .siovref(tmpSIOVREF__DigIn_3_net),
		  .interrupt({tmpINTERRUPT_0__DigIn_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DigIn_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DigIn_2_net;
	wire [0:0] tmpIO_0__DigIn_2_net;
	wire [0:0] tmpINTERRUPT_0__DigIn_2_net;
	electrical [0:0] tmpSIOVREF__DigIn_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("b7e9a2f0-6318-4f2f-80fd-39149293226f"),
		  ...
		  .input_buffer_sel(2'b00))
		DigIn_2
		 (.oe(tmpOE__DigIn_2_net),
		  .y({1'b0}),
		  .fb({Net_769}),
		  .io({tmpIO_0__DigIn_2_net[0:0]}),
		  .siovref(tmpSIOVREF__DigIn_2_net),
		  .interrupt({tmpINTERRUPT_0__DigIn_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DigIn_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DigOut_4_net;
	wire [0:0] tmpFB_0__DigOut_4_net;
	wire [0:0] tmpIO_0__DigOut_4_net;
	wire [0:0] tmpINTERRUPT_0__DigOut_4_net;
	electrical [0:0] tmpSIOVREF__DigOut_4_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("781b2652-031d-4494-baaa-8ce333683dea"),
		  ...
		  .input_buffer_sel(2'b00))
		DigOut_4
		 (.oe(tmpOE__DigOut_4_net),
		  .y({Net_751}),
		  .fb({tmpFB_0__DigOut_4_net[0:0]}),
		  .io({tmpIO_0__DigOut_4_net[0:0]}),
		  .siovref(tmpSIOVREF__DigOut_4_net),
		  .interrupt({tmpINTERRUPT_0__DigOut_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DigOut_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__DigOut_3_net;
	wire [0:0] tmpFB_0__DigOut_3_net;
	wire [0:0] tmpIO_0__DigOut_3_net;
	wire [0:0] tmpINTERRUPT_0__DigOut_3_net;
	electrical [0:0] tmpSIOVREF__DigOut_3_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("50cceaa8-b320-4e8a-84e1-f5970f119286"),
		  ...
		  .input_buffer_sel(2'b00))
		DigOut_3
		 (.oe(tmpOE__DigOut_3_net),
		  .y({Net_749}),
		  .fb({tmpFB_0__DigOut_3_net[0:0]}),
		  .io({tmpIO_0__DigOut_3_net[0:0]}),
		  .siovref(tmpSIOVREF__DigOut_3_net),
		  .interrupt({tmpINTERRUPT_0__DigOut_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DigOut_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DigOut_2_net;
	wire [0:0] tmpFB_0__DigOut_2_net;
	wire [0:0] tmpIO_0__DigOut_2_net;
	wire [0:0] tmpINTERRUPT_0__DigOut_2_net;
	electrical [0:0] tmpSIOVREF__DigOut_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("fa99cdb4-8493-4ba1-ad7c-114435bed677"),
		  ...
		  .input_buffer_sel(2'b00))
		DigOut_2
		 (.oe(tmpOE__DigOut_2_net),
		  .y({Net_748}),
		  .fb({tmpFB_0__DigOut_2_net[0:0]}),
		  .io({tmpIO_0__DigOut_2_net[0:0]}),
		  .siovref(tmpSIOVREF__DigOut_2_net),
		  .interrupt({tmpINTERRUPT_0__DigOut_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DigOut_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Wave_Gnd_net;
	wire [0:0] tmpFB_0__Wave_Gnd_net;
	wire [0:0] tmpIO_0__Wave_Gnd_net;
	wire [0:0] tmpINTERRUPT_0__Wave_Gnd_net;
	electrical [0:0] tmpSIOVREF__Wave_Gnd_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ac89f4d9-a91e-4ed7-bf7e-62f031441629"),
		  ...
		  .input_buffer_sel(2'b00))
		Wave_Gnd
		 (.oe(tmpOE__Wave_Gnd_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Wave_Gnd_net[0:0]}),
		  .io({tmpIO_0__Wave_Gnd_net[0:0]}),
		  .siovref(tmpSIOVREF__Wave_Gnd_net),
		  .interrupt({tmpINTERRUPT_0__Wave_Gnd_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Wave_Gnd_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    FreqDiv_v1_0 FreqDiv_1 (
        ...
        .reset(Net_1474),
        .clock(Net_116));
    defparam FreqDiv_1.Divider = 44;
    defparam FreqDiv_1.highPulse = 22;
    defparam FreqDiv_1.numBits = 6;

    assign Net_1472 = 1'h1;

    ZeroTerminal ZeroTerminal_2 (
        .z(Net_1474));


    assign Net_773 = ~Net_1482;
