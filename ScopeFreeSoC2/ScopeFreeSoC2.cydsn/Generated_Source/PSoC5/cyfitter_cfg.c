...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000758u)

/* IOPINS0_8 Address: CYREG_PRT15_DR Size (bytes): 10 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000760u)

/* IOPINS0_1 Address: CYREG_PRT1_DR Size (bytes): 10 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x4800076Cu)

/* IOPINS0_3 Address: CYREG_PRT3_DM0 Size (bytes): 8 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000778u)

/* IOPINS0_5 Address: CYREG_PRT5_DM0 Size (bytes): 8 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x48000780u)

/* IOPINS0_6 Address: CYREG_PRT6_DM0 Size (bytes): 8 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x48000788u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG4_CFG0), 0x008Fu);
	CY_SET_XTND_REG8((void CYFAR *)(CYREG_CLKDIST_DCFG4_CFG0 + 0x2u), 0x18u);
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG5_CFG0), 0x008Fu);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT0_AMUX, 0x0201u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT3_AG, 0xC0u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT5_AMUX, 0x8040u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DSM0_SW0, 0x28u);
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP0_MX, 0x0108u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP2_MX, 0x0101u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_BUS_SW0, 0x58u);
...
uint8 CYXDATA * const CYCODE Amux_Trigger__addrTable[2] = {
	(uint8 CYXDATA *)CYREG_CMP1_SW0, 
	(uint8 CYXDATA *)CYREG_CMP1_SW0, 
};

/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE Amux_Trigger__maskTable[2] = {
	0x40u, 
	0x80u, 
};

/*******************************************************************************
* Function Name: Amux_Trigger_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Amux_Trigger_Set(uint8 channel)
{
	if (channel < 2)
	{
		*Amux_Trigger__addrTable[channel] |= Amux_Trigger__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: Amux_Trigger_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Amux_Trigger_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*Amux_Trigger__addrTable[channel] &= (uint8)~Amux_Trigger__maskTable[channel];
	}
}
