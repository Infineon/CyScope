...
#define ADC_1_IRQ_INTC_VECTOR            ((reg32 *) ADC_1_IRQ__INTC_VECT)
...
#define ADC_1_IRQ_INTC_SET_EN            ((reg32 *) ADC_1_IRQ__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the ADC_1_IRQ interrupt. */
#define ADC_1_IRQ_INTC_CLR_EN            ((reg32 *) ADC_1_IRQ__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the ADC_1_IRQ interrupt state to pending. */
#define ADC_1_IRQ_INTC_SET_PD            ((reg32 *) ADC_1_IRQ__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the ADC_1_IRQ interrupt. */
#define ADC_1_IRQ_INTC_CLR_PD            ((reg32 *) ADC_1_IRQ__INTC_CLR_PD_REG)
